...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 1 : i32, ttg.target = "hip:gfx942", "ttg.threads-per-warp" = 64 : i32} {
  tt.func public @matmul_kernel(%arg0: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} loc("/triton/threadRake_test.py":114:0), %arg1: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} loc("/triton/threadRake_test.py":114:0), %arg2: !tt.ptr<f16> {tt.divisibility = 16 : i32, tt.pointer_range = 32 : i32} loc("/triton/threadRake_test.py":114:0), %arg3: i32 {tt.divisibility = 16 : i32} loc("/triton/threadRake_test.py":114:0), %arg4: i32 {tt.divisibility = 16 : i32} loc("/triton/threadRake_test.py":114:0), %arg5: i32 {tt.divisibility = 16 : i32} loc("/triton/threadRake_test.py":114:0), %arg6: i32 {tt.divisibility = 16 : i32} loc("/triton/threadRake_test.py":114:0), %arg7: i32 {tt.divisibility = 16 : i32} loc("/triton/threadRake_test.py":114:0), %arg8: i32 {tt.divisibility = 16 : i32} loc("/triton/threadRake_test.py":114:0)) attributes {noinline = false} {
    ...
    %1 = arith.addi %arg3, %c63_i32 : i32 loc(#loc47)
    %2 = arith.divsi %1, %c64_i32 : i32 loc(#loc48)
    %3 = arith.addi %arg4, %c63_i32 : i32 loc(#loc49)
    %4 = arith.divsi %3, %c64_i32 : i32 loc(#loc50)
    ...
    %40 = arith.addi %arg5, %c63_i32 : i32 loc(#loc51)
    %41 = arith.divsi %40, %c64_i32 : i32 loc(#loc52)
    %42 = arith.muli %arg7, %c64_i32 : i32 loc(#loc30)
    %43 = tt.splat %42 : i32 -> tensor<64x64xi32, #blocked> loc(#loc31)
    %44:3 = scf.for %arg9 = %c0_i32 to %41 step %c1_i32 iter_args(%arg10 = %cst_0, %arg11 = %29, %arg12 = %39) -> (tensor<64x64xf32, #mma>, tensor<64x64x!tt.ptr<f16>, #blocked>, tensor<64x64x!tt.ptr<f16>, #blocked>)  : i32 {
      %61 = tt.load %arg11 : tensor<64x64x!tt.ptr<f16>, #blocked> loc(#loc33)
      %62 = tt.load %arg12 : tensor<64x64x!tt.ptr<f16>, #blocked> loc(#loc34)
      %63 = ttg.convert_layout %61 : tensor<64x64xf16, #blocked> -> tensor<64x64xf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> loc(#loc33)
      %64 = ttg.convert_layout %62 : tensor<64x64xf16, #blocked> -> tensor<64x64xf16, #ttg.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> loc(#loc34)
      %65 = tt.dot %63, %64, %arg10, inputPrecision = tf32 : tensor<64x64xf16, #ttg.dot_op<{opIdx = 0, parent = #mma, kWidth = 4}>> * tensor<64x64xf16, #ttg.dot_op<{opIdx = 1, parent = #mma, kWidth = 4}>> -> tensor<64x64xf32, #mma> loc(#loc35)
      %66 = tt.addptr %arg11, %cst : tensor<64x64x!tt.ptr<f16>, #blocked>, tensor<64x64xi32, #blocked> loc(#loc36)
      %67 = tt.addptr %arg12, %43 : tensor<64x64x!tt.ptr<f16>, #blocked>, tensor<64x64xi32, #blocked> loc(#loc31)
      scf.yield %65, %66, %67 : tensor<64x64xf32, #mma>, tensor<64x64x!tt.ptr<f16>, #blocked>, tensor<64x64x!tt.ptr<f16>, #blocked> loc(#loc37)
    } loc(#loc32)
    %45 = arith.truncf %44#0 : tensor<64x64xf32, #mma> to tensor<64x64xf16, #mma> loc(#loc38)
    %46 = tt.splat %arg8 : i32 -> tensor<64x1xi32, #blocked> loc(#loc39)
    %47 = arith.muli %46, %20 : tensor<64x1xi32, #blocked> loc(#loc39)
    %48 = tt.splat %arg2 : !tt.ptr<f16> -> tensor<64x1x!tt.ptr<f16>, #blocked> loc(#loc40)
    %49 = tt.addptr %48, %47 : tensor<64x1x!tt.ptr<f16>, #blocked>, tensor<64x1xi32, #blocked> loc(#loc40)
    %50 = tt.broadcast %49 : tensor<64x1x!tt.ptr<f16>, #blocked> -> tensor<64x64x!tt.ptr<f16>, #blocked> loc(#loc41)
    %51 = tt.addptr %50, %36 : tensor<64x64x!tt.ptr<f16>, #blocked>, tensor<64x64xi32, #blocked> loc(#loc41)
    %52 = tt.splat %arg3 : i32 -> tensor<64x1xi32, #blocked> loc(#loc42)
    %53 = arith.cmpi slt, %20, %52 : tensor<64x1xi32, #blocked> loc(#loc42)
    %54 = tt.splat %arg4 : i32 -> tensor<1x64xi32, #blocked> loc(#loc43)
    %55 = arith.cmpi slt, %34, %54 : tensor<1x64xi32, #blocked> loc(#loc43)
    %56 = tt.broadcast %53 : tensor<64x1xi1, #blocked> -> tensor<64x64xi1, #blocked> loc(#loc44)
    %57 = tt.broadcast %55 : tensor<1x64xi1, #blocked> -> tensor<64x64xi1, #blocked> loc(#loc44)
    %58 = arith.andi %56, %57 : tensor<64x64xi1, #blocked> loc(#loc44)
    %59 = ttg.convert_layout %51 : tensor<64x64x!tt.ptr<f16>, #blocked> -> tensor<64x64x!tt.ptr<f16>, #mma> loc(#loc41)
    %60 = ttg.convert_layout %58 : tensor<64x64xi1, #blocked> -> tensor<64x64xi1, #mma> loc(#loc44)
    tt.store %59, %45, %60 : tensor<64x64x!tt.ptr<f16>, #mma> loc(#loc45)
    tt.return loc(#loc46)
  } loc(#loc)
} loc(#loc)
#loc1 = loc(unknown)
...
#loc32 = loc("/triton/threadRake_test.py":167:22)
#loc33 = loc("/triton/threadRake_test.py":171:24)
#loc34 = loc("/triton/threadRake_test.py":172:24)
#loc35 = loc("/triton/threadRake_test.py":177:35)
#loc36 = loc("/triton/threadRake_test.py":179:18)
#loc37 = loc("/triton/threadRake_test.py":180:8)
#loc38 = loc("/triton/threadRake_test.py":185:23)
#loc39 = loc("/triton/threadRake_test.py":191:33)
#loc40 = loc("/triton/threadRake_test.py":191:21)
#loc41 = loc("/triton/threadRake_test.py":191:52)
#loc42 = loc("/triton/threadRake_test.py":192:33)
#loc43 = loc("/triton/threadRake_test.py":192:58)
#loc44 = loc("/triton/threadRake_test.py":192:39)
#loc45 = loc("/triton/threadRake_test.py":193:21)
#loc46 = loc("/triton/threadRake_test.py":193:4)
#loc47 = loc(callsite(#loc3 at #loc4))
#loc48 = loc(callsite(#loc5 at #loc4))
#loc49 = loc(callsite(#loc3 at #loc6))
#loc50 = loc(callsite(#loc5 at #loc6))
#loc51 = loc(callsite(#loc3 at #loc29))
#loc52 = loc(callsite(#loc5 at #loc29))
