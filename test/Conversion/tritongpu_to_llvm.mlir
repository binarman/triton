...
#mfma0 = #triton_gpu.mfma<{nonKDim = 32, warpsPerCTA = [1, 1], xdlopsPerWarp = [1, 1]}>
...
#mfma = #triton_gpu.mfma<{nonKDim = 32, warpsPerCTA = [2, 2], xdlopsPerWarp = [1, 1]}>
module attributes {"triton_gpu.num-warps" = 1 : i32} {
  // CHECK: llvm.mlir.global external @global_smem() {addr_space = 3 : i32} : !llvm.array<0 x i8>
...
#shared = #triton_gpu.shared<{vec = 1, perPhase = 1, maxPhase = 1, order = [1, 0]}>
#mfma = #triton_gpu.mfma<{nonKDim = 32, warpsPerCTA = [2, 2], xdlopsPerWarp = [2, 4]}>
