...
./build/cmake.linux-x86_64-cpython-3.12/bin/triton-opt --allocate-amdgpu-shared-memory --convert-triton-amdgpu-to-llvm=arch=gfx942 --convert-builtin-func-to-llvm stage1.mlir &> stage2.mlir
