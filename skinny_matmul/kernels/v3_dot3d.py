...
def get_autotune_config():
    sizes = [
        {'BLOCK_SIZE_M': 1, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 256, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 1, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 2, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 256, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 2, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 4, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 256, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 4, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 8, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 256, 'GROUP_SIZE_M': 1},
        {'BLOCK_SIZE_M': 8, 'BLOCK_SIZE_N': 1, 'BLOCK_SIZE_K': 512, 'GROUP_SIZE_M': 1},
    ]
    return [triton.Config(s | {'matrix_instr_nonkdim': 0}, num_warps=1, num_stages=1) for s in sizes] + \
           ...
           [triton.Config(s | {'matrix_instr_nonkdim': 0}, num_warps=1, num_stages=2) for s in sizes] + \
