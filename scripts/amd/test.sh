...
pytest -rfs --verbose \
	python/test/unit/language/test_core.py::test_masked_load \
	python/test/unit/language/test_core.py::test_masked_load_shared_memory \
	2>&1 | tee /dockerx/triton/test_core.log
